...
if dein#load_state(g:dein#cache_directory)
    ...
    call dein#add('https://github.com/bfredl/nvim-ipy')
    ...
    " ------------------ Markdown/Writing -------------------
    let d = {'on_ft': 'markdown'}
    call dein#add('iamcco/mathjax-support-for-mkdp', d)
    call dein#add('iamcco/markdown-preview.vim', d)
    call dein#add('dhruvasagar/vim-table-mode', d)
    call dein#add('junegunn/goyo.vim', d)
    call dein#add('shime/vim-livedown', d)
    " call dein#add('suan/vim-instant-markdown', d)
    " ------------------ Completer ---------------------
