...
" ------------------ Utility -------------------- {{{
    ...
    call dein#add('terryma/vim-expand-region', {
                ...
                \ })
    call dein#add('joereynolds/SQHell.vim', {'on_cmd': 'SQH*'})
    " call dein#add('devjoe/vim-codequery', {'on_cmd': 'CodeQuery*'})
...
" ------------------ Completer --------------------- {{{
    ...
    call dein#add('autozimu/LanguageClient-neovim', {'name': 'lsp-client', 'do': ':UpdateRemotePlugins'})
